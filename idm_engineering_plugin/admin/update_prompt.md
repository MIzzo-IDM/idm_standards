...
1. The engineering quality guidelines document ("guidelines doc") is in `$ROOT/style_guide/engineering_quality_guidelines.md`, where `$ROOT` is the IDM Standards root folder.
