Your task is to update the IDM-Eng-Plugin (comprising the Engineering Quality Checker and Engineering Quality Fixer skills and agents) based on updates to the engineering quality guidelines.
...
6. Update the changelog (`$ROOT/idm-eng-plugin/CHANGELOG.md`) with key changes made (no more than 5-10 points max, 1 or 2 is fine).
