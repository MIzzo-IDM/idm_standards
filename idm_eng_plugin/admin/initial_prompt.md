...
# Step 2: Write Engineering Quality Checker

For the plugin, I want two agents and/or skills (whichever you think makes more sense): an Engineering Quality Checker and an Engineering Quality Fixer.

For the Engineering Quality Checker:
...
# Step 3: Write Engineering Quality Fixer

For the Engineering Quality Fixer:
1. Read the recommendations from `engineering_score.md` and make a prioritized plan for implementing them. (If this file doesn't exist, ask the user to run the Engineering Quality Checker first.)
